...
class Album {
    ...
    display = function() {
        return `${this._artist} : ${this._title} has been played the most. 
        The album has been played ${this._played} times.`;
    }
}
...
const album2 = new Album('The Beatles', 'Sergeant Pepper');
...
// vim: ft=javascript ai et ts=4 nu
